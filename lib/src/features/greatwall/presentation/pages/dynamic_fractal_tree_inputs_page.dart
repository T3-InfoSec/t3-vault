...
import '../../../../common/cryptography/presentation/widgets/eka_flow_handler_widget.dart';
...
class DynamicFractalTreeInputsPage extends StatelessWidget {
  static const routeName = 'dynamic_fractal_inputs';
  ...
  DynamicFractalTreeInputsPage({super.key});

  @override
  Widget build(BuildContext context) {
    _arityController.text = '-1';
    return Scaffold(
      appBar: AppBar(
        title: Text(AppLocalizations.of(context)!.dynamicFractalTreeInputsPageTitle),
        leading: IconButton(
                          ...
                          const Duration(seconds: 1),
                            ...
                            context.read<GreatWallBloc>().add(
                              GreatWallInitialized(
                                ...
                                tacitKnowledge: DynamicFractalTacitKnowledge(
                                    configs: {}),
